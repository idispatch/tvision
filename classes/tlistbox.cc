...
TListBox::TListBox(const TRect& bounds, ushort aNumCols, TScrollBar *aScrollBar) :
...
// SET:
TListBox::TListBox(const TRect& bounds, ushort aNumCols, TScrollBar *aHScrollBar,
        TScrollBar *aVScrollBar, Boolean aCenterOps) :
        TListViewer(bounds, aNumCols, aHScrollBar, aVScrollBar), items(0) {
    setRange(0);
    center = aCenterOps;
}
