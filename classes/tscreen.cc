...
void TScreen::defaultSetVideoMode(ushort mode) { // Set the screen mode
    setCrtMode(fixCrtMode(mode));
    // Cache the data about it and initialize related stuff
    setCrtData();
}

void TScreen::defaultSetVideoModeExt(char *mode) { // Set the screen mode
    setCrtModeExt(mode);
    // Cache the data about it and initialize related stuff
    setCrtData();
}
...
int TScreen::defaultGetFontGeometryRange(unsigned &, unsigned &, unsigned &, unsigned &) {
    return 0;
}
int TScreen::defaultSetFont(int, TScreenFont256 *, int, TScreenFont256 *, int, int) {
    return 0;
}
