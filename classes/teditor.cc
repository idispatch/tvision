...
/*****************************************************************************
 ...
 That's a very old port found in RHIDE beta 4. As Robert incorporated my
 ...
 As a user asked about the missing classes like TEditor I took this old
...
inline int isWordChar(int ch) { // SET: changed by the uchar version
...
const ushort firstKeys[] = { 39, kbCtA, cmWordLeft, kbCtC, cmPageDown, kbCtD, cmCharRight, kbCtE,
        cmLineUp, kbCtF, cmWordRight, kbCtG, cmDelChar, kbCtH, cmBackSpace, kbCtK, 0xFF02, kbCtL,
        cmSearchAgain, kbCtM, cmNewLine, kbCtO, cmIndentMode, kbCtQ, 0xFF01, kbCtR, cmPageUp, kbCtS,
        cmCharLeft, kbCtT, cmDelWord, kbCtU, cmUndo, kbCtV, cmInsMode, kbCtX, cmLineDown, kbCtY,
        cmDelLine,
        ...
        kbCtLeft, cmWordLeft, kbCtRight, cmWordRight, kbCtPgUp, cmTextStart, kbCtPgDn, cmTextEnd,
        kbCtInsert, cmCopy, kbCtDelete, cmClear, kbShInsert, cmPaste, kbShDelete, cmCut, kbLeft,
        cmCharLeft, kbRight, cmCharRight, kbHome, cmLineStart, kbEnd, cmLineEnd, kbUp, cmLineUp,
        kbDown, cmLineDown, kbPgUp, cmPageUp, kbPgDn, cmPageDown, kbDelete, cmDelChar, kbInsert,
        cmInsMode, kbEnter, cmNewLine, kbBackSpace, cmBackSpace };
...
const ushort quickKeys[] = { 8, kbA, cmReplace, kbC, cmTextEnd, kbD, cmLineEnd, kbF, cmFind, kbH,
        cmDelStart, kbR, cmTextStart, kbS, cmLineStart, kbY, cmDelEnd };

const ushort blockKeys[] = { 5, kbB, cmStartSelect, kbC, cmPaste, kbH, cmHideSelect, kbK, cmCopy,
        kbY, cmCut };
...
TEditor::TEditor(const TRect& bounds, TScrollBar *aHScrollBar, TScrollBar *aVScrollBar,
        TIndicator *aIndicator, uint32 aBufSize) :
        TView(bounds), hScrollBar(aHScrollBar), vScrollBar(aVScrollBar), indicator(aIndicator), bufSize(
                aBufSize), canUndo(True), selecting(False), overwrite(False), autoIndent(False), lockCount(
                0), keyState(0) {
...
void TEditor::deleteRange(uint32 startPtr, uint32 endPtr, Boolean delSelect) {
...
Boolean TEditor::insertBuffer(char *p, uint32 offset, uint32 length, Boolean allowUndo,
        Boolean selectText) {
    selecting = False;
