...
TMenuItem::TMenuItem(const char *aName, ushort aCommand, ushort aKeyCode, ushort aHelpCtx,
        const char *p, TMenuItem *aNext) {
    name = newStr(aName);
    intlName = NULL;
    command = aCommand;
...
TMenuItem::TMenuItem(const char *aName, ushort aKeyCode, TMenu *aSubMenu, ushort aHelpCtx,
        TMenuItem *aNext) {
    name = newStr(aName);
    intlName = NULL;
    command = 0;
    ...
    do {
        ...
        case evKeyDown:
            ...
            default:
                ...
                } else { // SET: without alt pressed, look here.
