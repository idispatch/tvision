...
.PHONY:  maintainance rhtv-config$(EXE_EXT) dynamic-lib internac install-dynamic install-internac  install-headers install-config clean \
	intl-dummy examples

all:  maintainance rhtv-config$(EXE_EXT) dynamic-lib internac intl-dummy
...
install: install-dynamic install-internac  install-headers install-intl-dummy install-config
