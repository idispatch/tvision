...
public:
    ...
    static void SetCodePage(int idCP) {
        SetCodePage(idCP, idCP, idCP);
    }
    ;
    static void SetScreenCodePage(int idCP) {
        SetCodePage(curAppCP, idCP, curInpCP);
    }
    ;
    static void SetInputCodePage(int idCP) {
        SetCodePage(curAppCP, curScrCP, idCP);
    }
    ;
    ...
    *GetList(void);
    ...
    static Boolean OnTheFlyRemapNeeded() {
        return NeedsOnTheFlyRemap ? True : False;
    }
    static uchar OnTheFlyRemap(uchar val) {
        return OnTheFlyMap[val];
    }
    static Boolean OnTheFlyRemapInpNeeded() {
        return NeedsOnTheFlyInpRemap ? True : False;
    }
    static uchar OnTheFlyInpRemap(uchar val) {
        return OnTheFlyInpMap[val];
    }
    static void CreateCPFromUnicode(CodePage *cp, int id, const char *name, ushort *unicodes);
    ...
    static int GetAppCodePage() {
        return curAppCP;
    }
    static int GetScrCodePage() {
        return curScrCP;
    }
    static int GetInpCodePage() {
        return curInpCP;
    }
    ...
    // Just to avoid using the magic, look in codepage.cc for more information
    enum {
        PC437 = 437,
        PC737 = 737,
        PC775 = 775,
        ...
        ISOGreek = 88597,
        ISO9 = 88599,
        ISOLatin1Linux = 885901,
        ISOLatin1uLinux = 885911,
        ISO14 = 885914,
        ISOIceland = 885915,
        ISOLatin2uLinux = 885921,
        ISOLatin2Linux = 885920,
        ISOLatin2Sun = 885922,
        ISOLatin2eLinux = 885923,
        KOI8r = 100000,
        KOI8_CRL_NMSU = 100001,
        MacOSUkrainian = 100072,
        OsnovnojVariantRussian = 885951,
        AlternativnyjVariantRU = 885952,
        UcodeRussian = 885953,
        Mazovia = 1000000,
        ISO5427 = 3604494,
        ECMACyr = 17891342,
...
protected:
    ...
    enum {
        alphaChar = 1, lowerChar = 2, upperChar = 4, digitChar = 8
    };
